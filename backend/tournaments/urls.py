...
urlpatterns = [
    ...
    path('registration/<int:pk>/payment-with-shop/', views.payment_with_shop, name='payment_with_shop'),
    path('tournament/<int:tournament_pk>/calculate-shop-discount/', views.calculate_shop_discount, name='calculate_shop_discount'),
    ...
    path('team/<int:team_pk>/upload-banner/', views.upload_team_banner, name='upload_team_banner'),
    path('player/<int:player_pk>/upload-banner/', views.upload_player_banner, name='upload_player_banner'),

...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "templates"],  # hoặc os.path.join(BASE_DIR, "templates")
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
SITE_ID = 2  # vì id=2 là '127.0.0.1:8000'
LOGIN_REDIRECT_URL = "/"
...
# allauth cần dòng này trong TEMPLATES
